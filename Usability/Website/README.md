## NOTE ##
Need to start a redis server using 'redis-server' on the command line
 - Attempted using fork however closing servers becomes an issue
Disabling cookie tracking will also cause certain security precautions to automatically fail.
